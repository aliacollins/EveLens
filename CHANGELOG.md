...
- **The SKINR Hub** -- The SKINR viewer grew into a full studio: the 3D ship fills the window with the design's name, tier, and hull identity overlaid; a design carousel along the bottom shows real rendered thumbnails of your collection (captured as you browse, instant forever after); live search filters designs by name or hull; and an environment switcher offers five looks -- Studio, Hangar, Space, Sunlight, and Beauty -- applied without rebuilding the ship. The Hub wears its own violet identity as EveLens's creative-marketplace space.
