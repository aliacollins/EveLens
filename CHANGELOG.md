...
- **Photo op: assemble your fleet** -- The SKINR stage learned formation flying: a new Photo Op button lets you pick up to four of your other designs as wingmen, and they build in and take echelon positions around the ship on stage -- spaced by each hull's real measured size, so a shuttle and a battleship both sit right. The camera pulls back to frame the whole formation against the nebula (a photo op happens in open space; heading back to the hangar, or loading a new design, quietly disbands the escort). Your ships, your skins, one screenshot.
