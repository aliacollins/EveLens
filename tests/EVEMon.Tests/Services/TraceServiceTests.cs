...
namespace EVEMon.Tests.Services
{
    ...
    /// and that the circular delegation footgun (TraceServiceAdapter -> EveMonClient ->
    ...
    public class TraceServiceCircularDelegationTests
    {
        ...
        public void AppServices_DefaultTraceService_IsNotTraceServiceAdapter()
        {
            ...
            // Trace() causes infinite recursion: adapter -> EveMonClient.Trace() ->
            ...
            svc.Should().NotBeOfType<TraceServiceAdapter>(
                "TraceServiceAdapter delegates to EveMonClient.Trace which delegates back to AppServices.TraceService");
        }
