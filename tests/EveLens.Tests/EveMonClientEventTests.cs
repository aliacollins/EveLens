...
namespace EveLens.Tests
{
    /// <summary>
    /// Tests for EveLensClient event propagation and UpdateBatcher integration.
    /// Note: EveLensClient is static, so these tests verify behavior at the integration boundary.
    /// Full event propagation tests require static data files to be loaded.
    /// </summary>
    public class EveLensClientEventTests
    {
        [Fact]
