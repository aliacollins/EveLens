        ...
        public static async Task RestoreAsync(string filename)
        {
            ...
            else
            {
                ...
                if (migration.MigrationDetected)
                {
                    ...
                    string message = @"This backup appears to be from a different version of EveLens.

The ESI authentication tokens in this backup won't work with this version of EveLens (they're tied to the original application).
