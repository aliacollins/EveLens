...
// NOTE: Do NOT use EveLens.Common.Threading.Dispatcher (WinForms-only).
...
namespace EveLens.Common.Services
{
    ...
    internal sealed class CharacterQueryOrchestrator : ICharacterQueryManager, ICharacterDataQuerying
    {
        ...
        // Using int instead of the enum to avoid dependency from EveLens.Core on EveLens.Common.
