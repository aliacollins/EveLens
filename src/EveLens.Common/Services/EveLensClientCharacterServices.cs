...
{
    /// <summary>
    /// Production implementation that delegates to EveLensClient statics.
    ...
    /// </summary>
    internal sealed class EveLensClientCharacterServices : ICharacterServices, IDisposable
    {
        internal static readonly EveLensClientCharacterServices Instance = new();
        ...
        private EveLensClientCharacterServices()
        {
