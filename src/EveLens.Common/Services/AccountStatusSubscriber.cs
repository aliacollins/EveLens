...
namespace EveLens.Common.Services
{
    ...
    /// Extracted from EveLensClient.OnESIKeyCollectionChanged() and OnCharacterSkillQueueUpdated()
    ...
    public sealed class AccountStatusSubscriber : IDisposable
    {
        ...
        /// <summary>
        /// Initializes the singleton instance. Call from EveLensClient.Initialize().
        /// </summary>
