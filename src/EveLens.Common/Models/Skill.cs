...
namespace EveLens.Common.Models
{
    ...
    public sealed class Skill : IStaticSkill
    {
        ...
        // Previous dev of EveLens made these longs, when patently unnecessary
        ...
        /// <summary>
        /// Gets the current level of this skill, as gotten from CCP or possibly estimated by EveLens according to training informations.
        /// </summary>
        public long Level
        {
            get
