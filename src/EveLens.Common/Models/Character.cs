    ...
    public abstract class Character : BaseCharacter, ICharacterIdentity
    {
        ...
        public string GetActiveShipText()
        {
            string shipText = !string.IsNullOrEmpty(ShipTypeName) && !string.IsNullOrEmpty(ShipName)
                ? $"{ShipTypeName} [{ShipName}]" : EveLensConstants.UnknownText;
        ...
        public string GetLastKnownLocationText()
        {
            if (LastKnownLocation == null)
                return EveLensConstants.UnknownText;
        ...
        /// <summary>
        /// Sets the base attribute value from ESI.
        /// ESI returns base + implant, so subtract the implant bonus.
        /// </summary>
        ...
        private void SetAttribute(EveAttribute attribute, int value)
        {
            ...
            m_attributes[(int)attribute].Base = value - implantBonus;
        }
        ...
        /// replacing the former <c>EveLensClient.OnCharacterUpdated(this)</c> call.
        ...
        private void OnCharacterChanged()
        {
            ...
            ServiceLocator.EventAggregator?.Publish(
                new EveLens.Common.Events.CharacterUpdatedEvent(this));
        }

        /// <summary>
        /// Publishes a character-label-changed event via the EventAggregator,
        /// replacing the former <c>EveLensClient.OnCharacterLabelChanged(this)</c> call.
        /// </summary>
        private void OnCharacterLabelChanged()
        {
            ...
            ServiceLocator.EventAggregator?.Publish(
                new EveLens.Common.Events.CharacterLabelChangedEvent(this, labels));
        }
