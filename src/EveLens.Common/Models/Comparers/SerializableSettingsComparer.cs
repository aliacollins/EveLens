...
{
    /// <summary>
    /// Performs a comparison between two <see cref="EveLens.Common.Serialization.Settings.SerializableSettings"/> types.
    /// </summary>
    public sealed class SerializableSettingsComparer : IEqualityComparer<SerializableSettings>
    {
        ...
        /// </summary>
        /// <param name="x">The first object of type <see cref="EveLens.Common.Serialization.Settings.SerializableSettings" /> to compare.</param>
        /// <param name="y">The second object of type <see cref="EveLens.Common.Serialization.Settings.SerializableSettings" /> to compare.</param>
        /// <returns>
