...
namespace EveLens.Common.Service
{
    ...
    public static class Emailer
    {
        ...
        {
            s_isTestMail = true;
            SendMail(settings, "EveLens Test Mail", "This is a test email sent by EveLens");
        }
            ...
            try
            {
                ...
                if (s_isTestMail)
                {
                    ShowMessageBox(@"The message sent successfully. Please verify that the message was received.",
                        @"EveLens Emailer Success", DialogIcon.Information);
                }
            }
            catch (Exception e)
            {
                ...
                ShowMessageBox(e.Message, @"EveLens Emailer Error", DialogIcon.Error);
            }
        }
