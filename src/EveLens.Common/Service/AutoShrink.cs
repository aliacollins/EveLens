...
// Submitted by Jay Beavers to EveLens as an enhancement, permission to include in EveLens and use appropriately.
...
namespace EveLens.Common.Service
{
    ...
    public static class AutoShrink
    {
        ...
        {
            // Note by Jimi (03-2012): Reading several posts about GC.Collect usage being a bad practice and monitoring EveLens behavior
