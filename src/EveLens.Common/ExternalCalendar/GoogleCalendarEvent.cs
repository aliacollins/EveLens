...
using EveLens.Common.CloudStorageServices.GoogleDrive;
...
namespace EveLens.Common.ExternalCalendar
{
    /// <summary>
    ...
    public sealed class GoogleCalendarEvent : CalendarEvent
    {
        ...
        /// <param name="checkAuth">if set to <c>true</c> [check authentication].</param>
        /// <returns></returns>
        /// <exception cref="EveLens.Common.Exceptions.APIException"></exception>
