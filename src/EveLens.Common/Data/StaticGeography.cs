...
namespace EveLens.Common.Data
{
    ...
    public static class StaticGeography
    {
        ...
        /// </summary>
        /// <param name="id">The id.</param>
        /// <returns>The system name, or EveLensConstants.UnknownText if no system has this ID</returns>
        public static string GetSolarSystemName(int id)
        {
            return GetSolarSystemByID(id)?.Name ?? EveLensConstants.UnknownText;
        }
