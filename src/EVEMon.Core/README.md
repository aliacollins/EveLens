...
Interfaces, events, and ServiceLocator. **Zero dependencies** on other EVEMon assemblies. Every other assembly depends on this.
...
- `ServiceLocator` -- static bridge for assemblies that can't reference EVEMon.Common
- `ICharacterIdentity`, `IStation` -- minimal model interfaces

## What does NOT go here
- Implementations (those go in Infrastructure or Common/Services)
- Anything that references EVEMon.Data, Models, or Common types
