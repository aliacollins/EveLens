...
namespace EveLens.Core.Interfaces
{
    ...
    /// <c>Station</c> class in <c>EveLens.Common.Data</c>. Consumers that need typed access
    ...
    ///
    /// Production: <c>StationResolverAdapter</c> in <c>EveLens.Common/Services/StationResolverAdapter.cs</c>
