...
namespace EveLens.Core.Interfaces
{
    ...
    /// Avoids dependency on the full <c>Character</c> model hierarchy in <c>EveLens.Common</c>.
    /// </summary>
    /// <remarks>
    ...
    ///
    /// Production: Implemented by <c>Character</c> in <c>EveLens.Common/Models/Character.cs</c>.
