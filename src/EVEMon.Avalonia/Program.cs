...
namespace EVEMon.Avalonia
{
    internal static class Program
    {
        ...
        {
            // Set taskbar identity so Windows groups the window as "EVEMon NexT"
            // instead of using the executable name "EVEMon.Avalonia.exe"
            SetCurrentProcessExplicitAppUserModelID("EVEMon");
            ...
            // Single-instance check — prevent multiple EVEMon sessions
            ...
            if (ApplicationLifetime is IClassicDesktopStyleApplicationLifetime desktop)
            {
                ...
                window.Content = new StackPanel
                {
                    ...
                    Children =
                    {
                        new TextBlock
                        {
                            Text = "EVEMon NexT is already running",
                            FontSize = 16,
