...
namespace EVEMon.Avalonia.Views.Dialogs
{
    public partial class AboutWindow : Window
    {
        ...
        private Control BuildAboutTab()
        {
            ...
            {
                Text = "EVEMon NexT is a complete rebuild of EVEMon \u2014 the character monitoring and "
            ...
            // Support
            AddSectionHeader(stack, "SUPPORT EVEMON", 16);
            stack.Children.Add(new TextBlock
            {
                Text = "I don't accept donations. Please donate to Peter Han or the original "
                     + "EVEMonDevTeam who built this tool.",
            ...
            AddLinkButton(linksPanel, "evemon.dev", BuildInfo.Website);
            AddLinkButton(linksPanel, "github.com/aliacollins/evemon", BuildInfo.Repository);
        ...
        private Control BuildLegalTab()
        {
            ...
            gplStack.Children.Add(new TextBlock
            {
                Text = "EVEMon NexT is free software: you can redistribute it and/or modify it under the "
            ...
            {
                ("Originally created by ", "EVEMonDevTeam", " (2006)"),
                ("Maintained by ", "Jimi, Peter Han", " and community contributors"),
                ("Community fork by ", "InfinitasX (mgoeppner)", ""),
                ("EVEMon NexT by ", "Alia Collins", " (2026)"),
            };
