...
namespace EveLens.Avalonia.Views.CharacterMonitor
{
    public partial class CharacterFactionalWarfareView : UserControl
    {
        ...
        {
            EnableTitle.Text = Loc.Get("ListView.EnableFW");
            EnableSubtext.Text = Loc.Get("ListView.EnableToFetch");
            EnableBtn.Content = Loc.Get("ListView.EnableFWBtn");
        ...
        private void LoadData()
        {
            ...
            if (oc != null && !oc.HasScopeFor(ESIAPICharacterMethods.FactionalWarfareStats))
            {
