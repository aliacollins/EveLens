...
namespace EVEMon.Common.Net
{
    ...
    public sealed class HttpWebClientServiceException : Exception
    {
        ...
        /// <summary>
        /// Resolver for the current proxy host. Set by the application during startup
        /// to decouple from HttpWebClientServiceState.
        /// Falls back to the system default proxy if not set.
        /// </summary>
        public static Func<Uri, string> ProxyHostResolver { get; set; }
        ...
        {
            if (ProxyHostResolver != null)
                return ProxyHostResolver(url);

            // Fallback: use system default proxy
