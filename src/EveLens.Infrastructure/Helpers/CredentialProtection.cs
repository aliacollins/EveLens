...
namespace EveLens.Common.Helpers
{
    ...
    public static class CredentialProtection
    {
        ...
        private static readonly byte[] s_entropy = Encoding.UTF8.GetBytes("EveLens.Credentials.v1");
        ...
        public static string Encrypt(string plainText)
        {
            ...
            //{
            //    EveLensClient.Trace($"CredentialProtection.Encrypt failed: {ex.Message}");
        ...
        public static string Decrypt(string encryptedText)
        {
            ...
            //    EveLensClient.Trace($"CredentialProtection.Decrypt failed (expected on new machine): {ex.Message}");
            //    return null;
            //}
            //catch (FormatException ex)
            //{
            //    // Invalid base64
            //    EveLensClient.Trace($"CredentialProtection.Decrypt failed (invalid format): {ex.Message}");
            //    return null;
            //}
        }
